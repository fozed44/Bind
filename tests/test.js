...
var bind = require("../source/bindSerializer");
...
var testResult = bind.bind.QueryStringSerializer.serialize(testObj1);

var testObj = { name: "john", accounts: ["a", "b", "c"], friends: [testObj1, testObj2, testObj3], bestFriend: testObj1, misc: testObj4, last: testObj5}

testResult = bind.bind.QueryStringSerializer.serialize(testObj);
