...
bind.Animate = new function() {
    ...
    this.applyCreateGenericMultiAnimator = function applyCreateGenericMultiAnimator(applyTo){
        ...
        applyTo.prototype.animate = function(animationProperties){
            bind.Animate.createGenericMultiAnimator(this.element, animationProperties);
        }
    };

    (function(self){
        if(bind.queryObject && !bind.queryObject.prototype.animate){
            self.applyCreateGenericMultiAnimator(bind.queryObject);
        }
    })(this);
}