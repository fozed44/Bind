    ...
    _bind.AJAX = new function () {
        ...
        function CreateHttpObject() {
            try { return new XMLHttpRequest(); }
                ...
                try { return new ActiveXObject("bindsoft.XMLHTTP"); }
        ...
        function getUrlOptionsProperty(options) {
            if (!options.url || typeof (options.url) != "string")
                throw new Error("AJAX: Invalid options. url property is missing or invalid.");
            return options.url;
        };

        function getTimeoutOptionsProperty(options) {
            if (options.timout != undefined && typeof (options.timeout) != "number")
                throw new Error("bindAJAX: Invalid options. timeout property is not a number.");
